...
MAINDIR=/storage/vivarga/ARGs_Invasion;
WORKDIR=$MAINDIR/Orthology;
OUTDIR=$MAINDIR/Orthology/USEARCH_Results;


### Run USEARCH
taskset --cpu-list 70-79 usearch \
-cluster_fast $WORKDIR/Concat_Pseudomonas_aeruginosa_CopyN_edit.fasta \
-id 0.99 -sort length -centroids $OUTDIR/Pa_CopyN_edit__centroids.fasta \
