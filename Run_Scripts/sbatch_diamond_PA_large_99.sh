...
###
# Title: sbatch_diamond_PA_large_99.sh
# Date: 2023.08.23
# Author: Vi Varga
#
# Description: 
...
# 
# Usage: 
# sbatch sbatch_diamond_PA_large_99.sh
###


### Set parameters
# key directories
MAINDIR=/cephyr/users/viragv/Vera/ARGs_Invasion;
WORKDIR=$MAINDIR/Data;
OUTDIR=$MAINDIR/Orthology/Diamond_Results;
...
-o $DIAMOND_TMP/PA_diamond_clust.txt --header --approx-id 99 -M 975G -p 60 --log;
