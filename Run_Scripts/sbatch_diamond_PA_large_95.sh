...
###
# Title: sbatch_diamond_PA_large_95.sh
# Date: 2023.08.23
# Author: Vi Varga
#
# Description: 
...
OUTDIR=$MAINDIR/Orthology/Diamond_Results/Identity95;
...
-o $DIAMOND_TMP/PA_diamond_clust.txt --header --approx-id 95 -M 975G -p 60 --log;
