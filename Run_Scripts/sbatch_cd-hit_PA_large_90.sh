...
###
# Title: sbatch_cd-hit_PA_large_90.sh
# Date: 2023.10.24
# Author: Vi Varga
#
# Description: 
...
OUTDIR=$MAINDIR/Orthology/CD-HIT_Results/Identity90;
...
-o $RESULTS_TMP/Concat_Pseudomonas_aeruginosa_CopyN_edit_90 -c 0.90 -n 5 -M 1000000 -T 64 -p 1 -g 1;
