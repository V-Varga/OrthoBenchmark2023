...
###
# Title: sbatch_mmseqs2_PA_large_90.sh
# Date: 2023.10.20
# Author: Vi Varga
#
# Description: 
...
OUTDIR=$MAINDIR/Orthology/MMseqs2_Results/Identity90;
...
apptainer exec $WORKING_TMP/env-mmseqs2.sif mmseqs createdb $WORKING_TMP/Concat_Pseudomonas_aeruginosa_CopyN_edit.fasta Pa_DB_90;

# cluster the database
mkdir $WORKING_TMP/Results/tmp;
apptainer exec $WORKING_TMP/env-mmseqs2.sif mmseqs cluster Pa_DB_90 Pa_DB_90_clu tmp --min-seq-id 0.90 --threads 64;

# generate a TSV file of the results
apptainer exec $WORKING_TMP/env-mmseqs2.sif mmseqs createtsv Pa_DB_90 Pa_DB_90 Pa_DB_90_clu Pa_DB_90_clu.tsv --threads 64;
